...
let AppComponent = class AppComponent {
    ...
    loadChecks() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            while (worked) {
                try {
                    const content = yield this.http.get(`assets/${counter}.txt`, {
                        responseType: 'text',
...
module.exports = __webpack_require__(/*! /home/adiehl/work/dsecheck/src/main.ts */"./src/main.ts");
